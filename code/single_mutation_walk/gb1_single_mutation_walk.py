...
MISSING_FITNESS = 0.0  # default fitness for missing variants
START_OPTIONS = [
    "wt",
    "reported",
    "all",
...
def main(start=START_OPTIONS[0]):
    ...
    for variant in start_variants:
        ...
        mutated_variant, fitness_progression = single_mutation_walk(
            variant, MUTATION_POSITIONS, variant_fitness
        )
